package neoatlantis.applications.accesscontroller.blockers;
 ...
 * @version 1.0
 */
public class ServerMemoryBlocker extends BlockerWay {
    private static final Logger DEBUGER = Logger.getLogger(ServerMemoryBlocker.class);
     ...
     * @param bloqueos 
     */
    public ServerMemoryBlocker(ServletContext context){
