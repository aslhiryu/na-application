...
import neoAtlantis.utils.apps.jmx.*;
...
import neoAtlantis.utils.apps.printer.interfaces.LogViewerPrinter;
...
import neoAtlantis.utils.apps.web.AdminAppServlet;
import neoAtlantis.utils.apps.web.filters.EncodingFilter;
...
public class ApplicationListener implements ServletContextListener {
    ...
    private void finalizeEnvironment(ServletContext context){
        ...
        unregisterMBean("neoAtlantis.app."+(DataUtils.cleanSpecialCharacters(this.app))+".sessions.jmx:type=InfoStatusSessions");
        
        //remueve el registro del MBean de estadisticas de pagina
        unregisterMBean("neoAtlantis.app."+(DataUtils.cleanSpecialCharacters(this.app))+".pagesReponse.jmx:type=PagesStatistics");

        //valida si se cargo el access controller
        if( this.nodoAccessControler!=null ){
            unregisterMBean("neoAtlantis.app."+(DataUtils.cleanSpecialCharacters(this.app))+".users.jmx:type=InfoStatusUsers");
        }
    }
...
//        context.setAttribute(PAGE_SIZE_KEY, 10);
    ...
    private void initEnvironment(ServletContext context){
        ...
        registerMBean(new InfoStatusSessionsMBean(context), InfoStatusSessions.class, "neoAtlantis.app."+(DataUtils.cleanSpecialCharacters(this.app))+".sessions.jmx:type=InfoStatusSessions");
        //carga el MBean de las estadisticas de pagina
        registerMBean(new PagesStatisticsMBean(context), PagesStatistics.class, "neoAtlantis.app."+(DataUtils.cleanSpecialCharacters(this.app))+".pagesReponse.jmx:type=PagesStatistics");
    }
